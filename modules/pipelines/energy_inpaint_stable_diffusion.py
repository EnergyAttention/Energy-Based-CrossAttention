...
class EnergyStableDiffusionInpaintPipeline(StableDiffusionInpaintPipeline, EnergyAttentionHook):
    ...
    def __call__(
        ...
        # TODO: generalize with B > 1 case & arbitrary w, h
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # TODO: forward mask as a attention_mask
