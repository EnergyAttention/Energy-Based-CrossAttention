"""
Modified for energy-based stable repainting
"""
...
from modules.pipelines.stable_diffusion_repaint import (
...
class EnergyStableDiffusionRepaintPipeline(StableDiffusionRepaintPipeline, EnergyAttentionHook):
    ...
    def downsample_mask(self, mask: torch.tensor, size: int):
    ...
    def __call__(
        ...
        downsample_mask_fn = lambda s: self.downsample_mask(mask.chunk(2)[0], s)
